...
module.exports = {
  ...
  base64ToBytes: function(base64) {
    return this.bufferToBytes(util.b64dec(base64));
  },
  ...
  generateDvsniCertificate: function(keyPair, nonceName, zName) {
    ...
    cert.sign(this.importPrivateKey(keyPair.privateKey));
  ...
  createContext: function(keyPair, cert) {
    var privateKey = this.importPrivateKey(keyPair.privateKey);
    var derCert    = this.bufferToBytes(util.b64dec(cert));
